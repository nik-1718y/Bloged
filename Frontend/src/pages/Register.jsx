...
//         // "https://bloged-11.onrender.com/api/users/register",
//         formData,
//         {
...
//           <div className='font-semiblod text-xl items-center text-center'>
...
//        className='w-full p-2 md-4 border rounded-md'>
        ...
        <form onSubmit={handleRegister}>
          ...
          <div className="flex items-center mb-4">
            <div className="w-20 h-20 mr-4">
              <img
                src={photoPreview ? photoPreview : "/imgPL.webp"}
                alt="photo"
